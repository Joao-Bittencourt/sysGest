...
<div id="leftSide">
	<div class="logo">
		<a href="<?php echo URL ?>Index">
			<img src="img/download.png" alt="" height="55" /> 
		</a>
	</div>
	...
	<div class="sideProfile">
		...
		<span>Olá <strong><?php echo 'ADM'?>,</strong> </span>
		<div class="clear"></div>
		<div class="sidedd">
	...
	<ul id="menu" class="nav">
		...
		<li class="files">
			...
			<ul class="sub">
				<li>
                                    <?= $this->Html->link('listar',['controller'=> 'pessoas', 'action'=>'index']); ?>
				</li>
				<li>
					<a  title="" class="exp">Funcionários</a>
					<ul class="sub">
						<li>
							 <?= $this->Html->link('listar2',['controller'=> 'TipoPessoas', 'action'=>'index']); ?>
						</li>
				...
				<li>
					<a  title="" class="exp">Funcões na Empresa</a>
					<ul class="sub">
						<li>
		...
		<li class="admin">
			...
			<ul class="sub">
				...
				<li>
					<a  title="" class="exp">Pedidos de Compra</a>
					<ul class="sub">
				...
				<li>
					<a  title="" class="exp">Fornecedores</a>
					<ul class="sub">
						<li>
		...
		<li class="logic">
			...
			<ul class="sub">
				...
				<li>
					<a  title="" class="exp">Blocos de Pedidos</a>
					<ul class="sub">
						<li>
				...
				<li>
					<a  title="" class="exp">Municipios </a>
					<ul class="sub">
						<li>
		...
		<li class="money">
			...
			<ul class="sub">
				...
				<li>
					<a  title="" class="exp">Extratos Bancários</a>
					<ul class="sub">
						<li>
		...
		<li class="up">
			...
			<ul class="sub">
				...
				<li>
					<a  title="" class="exp">Vencimentos</a>
					<ul class="sub">
						<li>
				...
				<li>
					<a  title="" class="exp">Prestações</a>
					<ul class="sub">
						<li>
				...
				<li>
					<a  title="" class="exp">Financiamentos</a>
					<ul class="sub">
						<li>
		...
		<li class="down">
			...
			<ul class="sub">
				...
				<li>
					<a  title="" class="exp">Cheques de Clientes </a>
					<ul class="sub">
						<li>
		...
		<li class="brasil">
			<a  title="" class="exp"><span>Fiscal </span></a> 
			<ul class="sub">
				<li>
					<a  title="" class="exp">Emissão</a>
					<ul class="sub">
						<li>
							<a  title="" class="exp">NFe</a>
							<ul class="sub">
								<li>
						...
						<li>
							<a  title="" class="exp">Notas Avulsas</a>
							<ul class="sub">
								<li>
						...
						<li>
							<a  title="" class="exp">Reduções Z</a>
							<ul class="sub">
								<li>
		...
		<li class="charts">
			<a  title="" class="exp"><span>Relatórios</span></a>
			<ul class="sub">
		...
		<li class="pdf">
			<a  title="" class="exp"><span>PDF</span></a>
			<ul class="sub">
